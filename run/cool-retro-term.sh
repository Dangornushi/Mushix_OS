...
echo "The mushix theme at '$dir/cool-retro-term.json' have to be manually imported."

# Launch qemu inside cool-retro-term
cool-retro-term --fullscreen --profile "mushix" --workdir "$dir/.." -e sh -c "$qemu 2>/dev/null"
