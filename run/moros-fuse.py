...
class mushixFuse(LoggingMixIn, Operations):
    chmod = None
    chown = None
    readlink = None
    rename = None
    ...
    def __init__(self, path):
        ...
        assert superblock[0:8] == b"mushix FS" # Signature
...
if __name__ == '__main__':
    ...
    fuse = FUSE(mushixFuse(args.image), args.mount, ro=False, foreground=True, allow_other=True)
